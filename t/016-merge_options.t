...
is_deeply(
    Data::Printer::Common::merge_options(undef, { foo => 42, bar => 27 }),
    { foo => 42, bar => 27 },
...
is_deeply(
    Data::Printer::Common::merge_options({}, { foo => 42, bar => 27 }),
    { foo => 42, bar => 27 },
    'merge hash and hash'
);
is_deeply(
...
my $merged = Data::Printer::Common::merge_options($old, $new);
